...
{
    internal class ServicePrincipalSecretManager : AzureSecretManager
    {
        public ServicePrincipalSecretManager(IConfigurationManager config, ILogger logger) : base(config, logger)
        {
        }
